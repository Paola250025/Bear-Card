...
def cta():
    return pg(f"""<div class="card" style="--fr:{TERRA};background:{GREEN};color:{CREAM};display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:0 160px">
      ...
      <div class="lab" style="font-size:30px;letter-spacing:3px;margin-bottom:18px">Comment below which one fits you</div>
      <div style="font-family:Arial;font-size:30px;color:{TERRA};letter-spacing:2px">Come try it in person &rarr; [ add your booking link ]</div></div>""")
